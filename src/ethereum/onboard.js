...
import {
  ...
  ONBOARD_CREATED,
  ONBOARD_UPDATED,
  ONBOARD_ADDRESS_CHANGE,
  ONBOARD_BALANCE_UPDATE,
  ONBOARD_NETWORK_CHANGE,
} from "./../redux/actions/OnboardActions";

const rpcUrl = configs.DEBUG_MODE
  ? configs.FALLBACK_PROVIDER_DEBUG
  : configs.FALLBACK_PROVIDER;
