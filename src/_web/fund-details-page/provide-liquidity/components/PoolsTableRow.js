            ...
            <>
                <div className="w-pools-table-row">
                    ...
                    <div className="w-pools-table-row-cell deposit">
                        <div className="">
                            <div className="w-pools-withdraw-button"
                            ...
                            >
                                ...
                                />
                                <div className="w-pools-withdraw-button-text">
                                    WITHDRAW
                                </div>
                            </div>
                            <div className="w-pools-deposit-button"
                            ...
                            >
                                ...
                                />
                                <div className="w-pools-deposit-button-text">
                                    DEPOSIT
                                </div>
                            </div>
                        </div>
