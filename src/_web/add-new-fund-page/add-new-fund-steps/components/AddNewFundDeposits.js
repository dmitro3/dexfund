        ...
        return (
            ...
            <>
                ...
                <div className="w-add-new-fund-step-input toggle-input">
                    <input type="text" id="minimum-deposit" name="minimumDeposit" placeholder="Minimum deposit"
                        value={this.state.minDeposit} onChange={(e) => this.setMinDeposit(e)}
                        style={{
                            color: '#fff',
                    ...
                    <input type="text" id="minimum-deposit" name="minimumDeposit" placeholder="Asset"
                        disabled
                        style={{
                            color: '#fff',
                            backgroundColor: '#070708',
    ...
    renderMaxDepositOn() {
        ...
        return (
            ...
            <>
                ...
                <div className="w-add-new-fund-step-input toggle-input">
                    <input type="text" id="maximum-deposit" name="maximumDeposit" placeholder="Maximum deposit"
                        value={this.state.maxDeposit} onChange={(e) => this.setMaxDeposit(e)}
                        style={{
                            color: '#fff',
                            backgroundColor: '#070708',
                            fontFamily: 'Bai Jamjuree, sans-serif',
                    ...
                    <input type="text" id="maximum-deposit" name="maximumDeposit" placeholder="Asset"
                        disabled
                        style={{
                            color: '#fff',
                            backgroundColor: '#070708',
            ...
            <>
                <div className="w-add-new-fund-step-card">
                    ...
                    <div className="w-add-new-fund-step-input-section">
                        {this.state.displayMinDeposit === false && this.renderMinDepositOff()}
                        {this.state.displayMinDeposit === true && this.renderMinDepositOn()}

                        {this.state.displayMaxDeposit === false && this.renderMaxDepositOff()}
