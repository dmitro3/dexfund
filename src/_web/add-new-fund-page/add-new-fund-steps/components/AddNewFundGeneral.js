...
class AddNewFundGeneral extends Component {
    ...
    goToNextStep = () => {
        if (this.state.fundName === '' || this.state.managerName === '' || this.state.denominationAsset === 'Denomination asset') {
            return
        } else {
            this.props.goToNextStepEvent(this.state.fundName, this.state.managerName, this.state.denominationAsset);
        }
    }
    ...
    renderAssetsListOn() {
        ...
        return (
            ...
            <>
                <div className="w-add-new-fund-step-input denomination-asset-input"
                ...
                <div className="w-add-new-fund-denomination-assets-list">
                    <div className="w-add-new-fund-denomination-asset-row"
                ...
                <div className="w-add-new-fund-step-card">
                    ...
                    <div className="w-add-new-fund-step-input-section">
                        <div className="w-add-new-fund-step-input">
                            <input type="text" id="new-fund-name" name="fundName" placeholder="Fund name"
                                value={this.state.fundName} onChange={(e) => this.setFundName(e)}
                                style={{
                                    color: '#fff',
                        ...
                        <div className="w-add-new-fund-step-input"
                            style={{ margin: '16px 0' }}>
                            <input type="text" id="new-fund-manager-name" name="managerName" placeholder="Manager name"
                                value={this.state.managerName} onChange={(e) => this.setManagerName(e)}
                                style={{
                                    color: '#fff',
                                    backgroundColor: '#070708',
                                    fontFamily: 'Bai Jamjuree, sans-serif',
                        ...
                        {this.state.denominationAssetsList === false && this.renderAssetsListOff()}
                        {this.state.denominationAssetsList === true && this.renderAssetsListOn()}
                        <div className="w-add-new-fund-step-info-text">
                            The denomination asset is the asset
                            in which depositors deposit into your vault
                            and in which the vault's share price
                            and the performance are measured.
                        </div>
                        <div className="w-add-new-fund-step-next-button"
                            onClick={() => this.goToNextStep()}
                            style={this.state.fundName === '' || this.state.managerName === '' || this.state.denominationAsset === 'Denomination asset' ? disabledNextButtonStyle : {}}
                        >
                            NEXT
                        </div>
                    </div>
