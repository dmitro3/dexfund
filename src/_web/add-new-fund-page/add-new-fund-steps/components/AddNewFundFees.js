...
class AddNewFundFees extends Component {
        ...
        return (
            ...
            <>
                <div className="w-add-new-fund-toggle-row">
                    <img src={toggleOffIcon} alt='toggle-off-icon' className="add-new-fund-toggle-icon"
                        onClick={() => this.setState({ displayManagementFee: true })}
                    />
                    <div className="w-add-new-fund-toggle-text">
                        Management fee
                    </div>
                </div>
            </>
    ...
    renderManagementFeeOn() {
        ...
        return (
            ...
            <>
                <div className="w-add-new-fund-toggle-row">
                    <img src={toggleOnIcon} alt='toggle-on-icon' className="add-new-fund-toggle-icon"
                ...
                <div className="w-add-new-fund-step-input toggle-input">
                    <input type="text" id="management-fee" name="managementFee" placeholder="Management fee"
                        value={this.state.managementFee} onChange={(e) => this.setManagementFee(e)}
                        style={{
                            color: '#fff',
                    ...
                    <input type="text" id="management-fee" name="managementFee" placeholder="%"
                        disabled
                        style={{
                            color: '#fff',
                            backgroundColor: '#070708',
    ...
    renderPerformanceFeeOn() {
        ...
        return (
            ...
            <>
                ...
                <div className="w-add-new-fund-step-input toggle-input">
                    <input type="text" id="management-fee" name="managementFee" placeholder="Performance fee"
                        value={this.state.performanceFee} onChange={(e) => this.setPerformanceFee(e)}
                        style={{
                            color: '#fff',
                            backgroundColor: '#070708',
                            fontFamily: 'Bai Jamjuree, sans-serif',
                    ...
                    <input type="text" id="percent" name="percent" placeholder="%"
                        disabled
                        style={{
                            color: '#fff',
                            backgroundColor: '#070708',
    ...
    renderEntryFeeOn() {
        ...
        return (
            ...
            <>
                ...
                <div className="w-add-new-fund-step-input toggle-input">
                    <input type="text" id="entry-fee" name="entryFee" placeholder="Entry fee"
                        value={this.state.entryFee} onChange={(e) => this.setEntryFee(e)}
                        style={{
                            color: '#fff',
                            backgroundColor: '#070708',
                            fontFamily: 'Bai Jamjuree, sans-serif',
                ...
                <div className="w-add-new-fund-step-card">
                    <div className="w-add-new-fund-step-sidebar">
                        ...
                        <div className="w-add-new-fund-step current">
                            <img src={pinkOutlineButtonIcon} alt="pink-outline-button-icon" className="add-new-fund-button-icon" />
                            <div className="w-add-new-fund-step-text current">
                                Fees (optional)
                            </div>
                        </div>
                        <div className="w-add-new-fund-step">
                            <img src={greyOutlineButtonIcon} alt="grey-outline-button-icon" className="add-new-fund-button-icon" />
                    ...
                    <div className="w-add-new-fund-step-input-section">
                        {this.state.displayManagementFee === false && this.renderManagementFeeOff()}
                        {this.state.displayManagementFee === true && this.renderManagementFeeOn()}

                        {this.state.displayPerformanceFee === false && this.renderPerformanceFeeOff()}
                        {this.state.displayPerformanceFee === true && this.renderPerformanceFeeOn()}
