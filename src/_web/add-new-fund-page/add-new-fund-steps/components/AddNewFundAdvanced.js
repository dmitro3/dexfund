            ...
            <div className="w-add-new-fund-policy-popup-wrapper">
                <div className="w-add-new-fund-policy-popup-box">
                    <div className="w-add-new-fund-policy-popup-header">
                        ...
                        <img src={closeIcon} alt='close-icon' className="policy-popup-close-icon"
                    ...
                    {this.state.displayPolicyPopupList === false && this.renderPoliciesListOff()}
                    {this.state.displayPolicyPopupList === true && this.renderPoliciesListOn()}
                    <div className="w-add-new-fund-policy-popup-policy-header">
                        {this.state.selectedPolicy !== 'Select' && this.state.selectedPolicy}
                    </div>
                    {this.state.selectedPolicy !== 'Select' && this.state.displaySelectedPolicyList === false && this.renderSelectedPolicyListOff()}
                    {this.state.selectedPolicy !== 'Select' && this.state.displaySelectedPolicyList === true && this.renderSelectedPolicyListOn()}
                </div>
            </div>
        </>
    )
        ...
        <>
            <div className="w-add-new-fund-step-card">
                ...
                <div className="w-add-new-fund-step-input-section">
                    ...
                    <div className="w-add-new-fund-step-input" style={{ margin: '32px 0' }}>
                        <input type="text" id="entry-fee" name="entryFee"
                            value={this.state.timeLock} onChange={(e) => this.setTimeLock(e)}
                            style={{
                                color: '#fff',
                    ...
                    <div className="w-add-new-fund-add-policy-button"
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(AddNewFundAdvanced);
